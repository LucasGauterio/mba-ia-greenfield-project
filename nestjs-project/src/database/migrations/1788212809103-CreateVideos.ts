...
export class CreateVideos1788212809103 implements MigrationInterface {
  name = 'CreateVideos1788212809103';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "channel_id" uuid NOT NULL, "slug" character varying(10) NOT NULL, "title" character varying(255), "status" "public"."videos_status_enum" NOT NULL DEFAULT 'draft', "error_reason" character varying(255), "storage_key" character varying(512) NOT NULL, "thumbnail_key" character varying(512), "upload_id" character varying(255), "duration_seconds" integer, "metadata" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5dbcc1ee100f853490582eccc71" UNIQUE ("slug"), CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
